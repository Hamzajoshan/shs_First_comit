                  ...
                  <div class="row">
                    <div class="col-md-12 col-12 col-sm-12">
                      <div class="slider-text-inner text-center">
                        ...
                        <h2 class="h2-blog-top">
                          <a href="./" class="h1-blog-top-a">
                            Home
                          </a>{" "}
                          - Blog
                        </h2>
            ...
            <div class="row">
              <div class="col-md-6">
                <article class="animate-box article">
                  ...
                  >
                    <span class="icon">
                      <i class="icon-search2 blog-icon-article"></i>
                    </span>
                  </a>
                  <div class="entry">
                    <h2 class="blogbox-h2">
                      <a href="#" class="blogbox-h2-a">
                    ...
                    <p class="meta-2">
                      <span class="iconx-span">
                        <i class="icon-calendar2 iconx"></i> March 1, 2017
                      </span>
                      <span class="iconx-span">
                        <i class="icon-user iconx"></i> Admin
                      </span>
                      <span class="iconx-span">
                        <i class="icon-dropbox iconx"></i> Articles
                      </span>
                    </p>
                    <p>
