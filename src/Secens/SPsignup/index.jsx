...
userId:""
 ...
 onAddressChange=(e)=>{
  ...
  selectedWorkInterest=(e)=>{
    ...
    // console.log(this.state.workInterestValue);
...
// console.log(this.state.legalTypeValue);
...
async selectedServiveProvider (e) {
 this.setState({ serviveProviderValue: e.target.value })
  ...
  let parentId = result.id;
  console.log('checking which parent id it is',parentId);
...
// }
  ...
  if (this.state.parentId==='' || this.state.childId==='') {
    ...
    //this.basicInfo();
    // this.createSP();
    //Make a call to API for update 
    const {Fname, Lname, email, username, password, confirmpassword, id, city, district, address, plocation, pnumber,refId,userId,workInterestId,legalTypeId,childId,parentId} = this.state;
    ...
    console.log('plocation',plocation);
    console.log('pnumber',pnumber);
    console.log('refId',refId);
    console.log('userId',userId);
    console.log('workInterestId',workInterestId);
    console.log('legalTypeId',legalTypeId);
    console.log('sptypes',childId,parentId);
// console.log(Fname,Lname,email,username,password,confirmpassword,id,city,district,address,plocation,pnumber,refId,userId,workInterestId,legalTypeId,childId,parentId);
    //Make API Call
    fetch(
      "https://shsbackend.azurewebsites.net/api/services/app/ServiceProvider/UpdateServiceProviderAsync",
      {
        method: "put",
        // mode: 'cors',
        // 'contentType': 'application/json',
        ...
        body: JSON.stringify({
          ...
          city: city,
          district: district,
          preferableLocations: plocation,
          spTypes:parentId,
          workIntrests:workInterestId,
...
{    
  ...
  if (this.state.plocation==="") {
    ...
    submitDisabled:false
        ...
        // make API call
        fetch(
          "https://shsbackend.azurewebsites.net/api/services/app/User/Create",
          {
            method: "post",
            // mode: 'cors',
            // 'contentType': 'application/json',
          ...
          .then(
            responseData => {
              ...
              if (!responseData.success) {
                ...
                this.setState({
                  refId:responseData.result.reffId,
                    ...
                    <div className="col-md-12">
                      ...
                      {this.state.errormessage? 
                        ...
                        <div className="form-group col-md-6">
                              ...
                              <div className="form-group col-md-6">
                                <input autocomplete="off" ref="phone" type="text" pattern="^((?:[+?0?0?966]+)(?:\s?\d{2})(?:\s?\d{7}))$"  maxLength="15" className="form-control mainLoginInput" id="inputDado" placeholder=" (00966) 1234-567*" value={this.state.pnumber} onChange={this.onPnumberChange}/>
                              ...
                              <div className="form-group col-md-6">
                            <input autocomplete="off" ref="id" type="id"  maxLength="10" minLength="10" className="form-control mainLoginInput" id="inputDado" placeholder=" ID*" value={this.state.id} onChange={this.onIdChange}/>
